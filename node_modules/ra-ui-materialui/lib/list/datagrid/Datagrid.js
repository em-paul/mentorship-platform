...
var Datagrid = React.forwardRef(function (props, ref) {
    ...
    var contextValue = react_1.useMemo(function () { return ({ isRowExpandable: isRowExpandable }); }, [
        isRowExpandable,
    ]);
    var updateSortCallback = react_1.useCallback(function (event) {
    ...
    return (React.createElement(DatagridContextProvider_1.default, { value: contextValue },
        React.createElement(core_1.Table, __assign({ ref: ref, className: classnames_1.default(classes.table, className), size: size }, ra_core_1.sanitizeListRestProps(rest)),
