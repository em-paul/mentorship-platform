...
var RadioButtonGroupInput = function (props) {
    ...
    if (loading) {
        return (React.createElement(Labeled_1.default, { id: id, label: label, source: source, resource: resource, className: rest.className, isRequired: isRequired, meta: meta, input: input },
