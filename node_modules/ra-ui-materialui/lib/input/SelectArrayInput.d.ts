...
export interface SelectArrayInputProps extends Omit<ChoicesProps, 'choices'>, Omit<InputProps<SelectProps>, 'source'>, Omit<FormControlProps, 'defaultValue' | 'onBlur' | 'onChange' | 'onFocus'> {
    choices?: object[];
    source?: string;
}
