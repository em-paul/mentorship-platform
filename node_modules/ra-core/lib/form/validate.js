...
exports.composeValidators = function () {
    ...
    return function (value, values, meta) { return __awaiter(void 0, void 0, void 0, function () {
        var allValidators, _i, allValidators_1, validator, errorPromise, error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    errorPromise = validator(value, values, meta);
                    if (!errorPromise) return [3 /*break*/, 3];
                    if (typeof errorPromise == 'string') {
                        return [2 /*return*/, errorPromise];
                    }
